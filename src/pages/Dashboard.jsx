...
const Dashboard = () => {
  ...
  return (
    <div className="bg-slate-300 md:h-[120vh] h-screen relative">
      ...
      <main className="md:px-24 mt-6 md:grid md:grid-cols-8 md:space-x-6 md:justify-between">
        ...
        <div className="graphnsection w-[100%]md:col-span-6  rounded-md shadow-xl flex flex-col md:space-y-4">
          <div className="bg-white shadow-xl md:h-[65%] h-[600px] mx-4 rounded-md p-2 flex flex-col md:justify-between items-center">
